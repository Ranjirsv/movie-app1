...
var movielist = {
    ...
    search: function(req, res, next) {
        ...
        request.get('https://api.themoviedb.org/3/search/movie?api_key=3d34e72c9badeb4e4254c09ec0109d8e&language=en-US&query=' + moviename + '&page=1&include_adult=false', function(err, response, body, data) {
